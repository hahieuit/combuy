...
?>
	<script type="text/javascript">
	 	function updatevalbt(e,a){
			if(a=='name'){
				document.getElementById('btl-input-name').value = e;
			}else{
				document.getElementById('btl-input-email2').value = e;
			}
		}
  	</script>
<div id="btl">
	...
	<div id="btl-content">
		...
		<div id="btl-content-login" class="btl-content-block">
			...
			<form name="btl-formlogin" class="btl-formlogin" action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post">
			     <h1>
                                 <span style="color: #ff7e82">ed</span><span style="color: #78c5d5">j</span><span style="color: #459ba8">o</span><span style="color: #79c268">y</span><span style="color: #bccd43">a</span><span style="color: #e5c939">b</span><span style="color: #f18c32">l</span><span style="color: #e868a1">e</span>
                             </h1>
		...
		<div class="social-connect">
			<div class="slogin-buttons " id="slogin-buttons">
                    <a href="/index.php?option=com_slogin&amp;task=auth&amp;plugin=facebook" title="Facebook" rel="nofollow"><span class="facebookslogin"><i class="fa fa-facebook"></i>以 Facebook 帳戶登入</span></a>
                    <a href="/index.php?option=com_slogin&amp;task=auth&amp;plugin=google" title="Google" rel="nofollow"><span class="googleslogin"><i class="fa fa-google"></i>以 Google 帳戶登入</span></a>
                        </div>
		</div>
		...
		<p class="or">或</p>
			...
			<div class="bottomregister">
				    <!--<div id="register-link">
						<?php echo '<a href="'.JRoute::_('index.php?option=com_users&view=registration').'">Register now</a>';?>
					</div>-->
				<ul id ="bt_ul">
					<li>
			...
			<?php if($integrated_com==''){?>	
				...
				<form name="btl-formregistration" class="btl-formregistration"  autocomplete="off">
					...
					<div class="btl-field">
						<div class="btl-label"><?php echo JText::_( 'MOD_BT_LOGIN_USERNAME' ); ?></div>
						<div class="btl-input">
							<input id="btl-input-username1" type="text" onchange="updatevalbt(this.value,'name')" name="jform[username]"  />
						</div>
					</div>
					<div class="clear"></div>
					...
					<div class="btl-field">
						...
						<div class="btl-input">
							<input id="btl-input-email1" onchange="updatevalbt(this.value,'email')" type="text" name="jform[email1]" />
						</div>
					</div>
					<div class="clear"></div>
					<div class="btl-field" style="display: none;">
